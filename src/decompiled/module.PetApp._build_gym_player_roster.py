# module.PetApp._build_gym_player_roster
# source line 16891
# Recovered from bytecode; default argument values are not shown.

def _build_gym_player_roster(self):
    chosen = self._get_preset_dex_list('gym')[<TYPE: 58>
    ]
    atk_pct = ()
    def_pct = companion_synergy_bonus(chosen, self.state.get('caught', { }), self.state.get('mega_party', []))
    self.body1_effective_level() = self.player_pokedex_entry()
